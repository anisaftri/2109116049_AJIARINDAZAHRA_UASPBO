...
public class DataBayi extends javax.swing.JFrame {
    Bayi B1;

    public DataBayi() throws ClassNotFoundException, SQLException {
        B1 = new Bayi();
        initComponents();
        this.showData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(430, 120, 180, 50);
        ...
        addData.setBounds(460, 470, 100, 40);
        ...
        jButton1.setBounds(190, 470, 150, 40);
        ...
        jButton2.setBounds(350, 470, 100, 40);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        try{ 
            ...
            if (id == null) { 
                ...
                try { 
                    B1.deletebayi(Integer.parseInt(id)); 
                } catch (SQLException ex) { 
                    Logger.getLogger(DataBayi.class.getName()).log(Level.SEVERE, null, ex); 
                } 
                try { 
        ...
        try{ 
            ...
            if (id == null) { 
                ...
                this.dispose(); 
                    ...
                    new upBayi(Integer.parseInt(id)).setVisible(true); 
                try {
                    this.showData(); 
                } catch (SQLException e) { 
                    // TODO Auto-generated catch block 
